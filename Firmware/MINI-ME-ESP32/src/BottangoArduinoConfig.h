...
#endif
#else
#define MAX_REGISTERED_EFFECTORS 18 // most modern boards can handle 16 or more (EX, ESP32, etc.)
#endif
...
#define WIFI_SSID "A118_IWT_TEMPORARY"                   // wifi ssid
#define WIFI_PASSWORD "VIVES_ELOICT"               // wifi password
#define WIFI_SERVER_IP "10.198.112.11"              // wifi server ip on the local network, likely something like 192.168.1.X
...
#define ANIMATION_STATE_SELECTION_PIN 13            // Pin to monitor on boot to determine if should be in live control or exported
...
#endif
#define READ_TIMEOUT 1000                                      // time in MS before timeout while reading incoming serial
